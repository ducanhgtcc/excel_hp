...
@AllArgsConstructor
@Entity
@Table(name = "order_kids_excel_t02")
public class OrderKidsExcelT02 extends BaseEntity<String> {
    ...
    @Column(name = "order_kid_code_t02", length = 45, nullable = false)
    private String orderKidCodeT02;
    ...
    @OneToMany(mappedBy = "orderKidsExcelT02", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
