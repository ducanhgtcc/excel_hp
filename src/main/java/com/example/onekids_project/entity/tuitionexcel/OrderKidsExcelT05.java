...
@AllArgsConstructor
@Entity
@Table(name = "order_kids_excel_t05")
public class OrderKidsExcelT05 extends BaseEntity<String> {
    ...
    @Column(name = "order_kid_code_t05", length = 45, nullable = false)
    private String orderKidCodeT05;
    ...
    @OneToMany(mappedBy = "orderKidsExcelT05", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
