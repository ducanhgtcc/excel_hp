...
@AllArgsConstructor
@Entity
@Table(name = "order_kids_excel_t08")
public class OrderKidsExcelT08 extends BaseEntity<String> {
    ...
    @Column(name = "order_kid_code_t08", length = 45, nullable = false)
    private String orderKidCodeT08;
    ...
    @OneToMany(mappedBy = "orderKidsExcelT08", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
