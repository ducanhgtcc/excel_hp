...
@AllArgsConstructor
@Entity
@Table(name = "order_kids_excel_t10")
public class OrderKidsExcelT10 extends BaseEntity<String> {
    ...
    @Column(name = "order_kid_code_t10", length = 45, nullable = false)
    private String orderKidCodeT10;
    ...
    @OneToMany(mappedBy = "orderKidsExcelT10", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
