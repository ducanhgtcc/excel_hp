...
@AllArgsConstructor
@Entity
@Table(name = "order_kids_excel_t04")
public class OrderKidsExcelT04 extends BaseEntity<String> {
    ...
    @Column(name = "order_kid_code_t04", length = 45, nullable = false)
    private String orderKidCodeT04;
    ...
    @OneToMany(mappedBy = "orderKidsExcelT04", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
