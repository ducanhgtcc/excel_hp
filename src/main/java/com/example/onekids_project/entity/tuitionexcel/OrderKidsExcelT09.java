...
@AllArgsConstructor
@Entity
@Table(name = "order_kids_excel_t09")
public class OrderKidsExcelT09 extends BaseEntity<String> {
    ...
    @Column(name = "order_kid_code_t09", length = 45, nullable = false)
    private String orderKidCodeT09;
    ...
    @OneToMany(mappedBy = "orderKidsExcelT09", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
