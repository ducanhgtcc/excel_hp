...
@AllArgsConstructor
@Entity
@Table(name = "order_kids_excel_t06")
public class OrderKidsExcelT06 extends BaseEntity<String> {
    ...
    @Column(name = "order_kid_code_t06", length = 45, nullable = false)
    private String orderKidCodeT06;
    ...
    @OneToMany(mappedBy = "orderKidsExcelT06", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
