...
@Getter
@Setter
public class AttendanceLeaveKidsDateResponse extends IdResponse {
...
//    private boolean absentLetterNo;
    ...
    private AttendanceLeaveKidsResponse attendanceLeaveKids;

    private ArriveLearnResponse attendanceArriveKids;
